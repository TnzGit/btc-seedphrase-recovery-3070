...
fn run_bench() {
    ...
    println!(
        "Bench config: block={}  lb_min_blocks={}  noinline_sha512_words={}  noinline_fixed64_hmac={}  noinline_pbkdf2={}  pbkdf2_scalar_ut={}  pbkdf2_t_shared={}  pbkdf2_state_shared={}",
        ...
        std::env::var("SEEDPHRASE_PBKDF2_STATE_SHARED").unwrap_or_else(|_| "0(default)".to_string()),
    );
    let wordlist = Language::English.word_list();
